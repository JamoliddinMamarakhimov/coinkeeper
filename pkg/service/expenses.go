...
func GetAllExpenses(userID uint, query string) (expenses []models.Expense, err error) {
	expenses, err = repository.GetAllExpenses(userID, query)
	if err != nil {
		return nil, err
	}
	return expenses, nil
...
func GetExpenseByID(userID, expenseID uint) (models.Expense, error) {
	...
	if err != nil {
		if errors.Is(err, errs.ErrRecordNotFound) {
			return models.Expense{}, errs.ErrOperationNotFound
		}
