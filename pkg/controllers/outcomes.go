...
func GetAllOutcomes(c *gin.Context) {
	query := c.Query("q")
	...
	outcomes, err := service.GetAllOutcomes(userID, query)
	if err != nil {
...
func CreateOutcome(c *gin.Context) {
	...
	if err := service.CreateOutcome(o); err != nil {
		handleError(c, err)
		return
	}
...
func UpdateOutcome(c *gin.Context) {
	...
	if err = service.UpdateOutcome(o); err != nil {
		handleError(c, err)
		return
	}
...
func DeleteOutcome(c *gin.Context) {
	...
	if err = service.DeleteOutcome(outcomeID, userID); err != nil {
		handleError(c, err)
		return
	}
